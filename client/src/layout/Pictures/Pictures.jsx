...
const Pictures = () => {
  ...
  const airstripPictures = [
    ...
    {alt:t("airstrip8"), src: Airstrip8},
    {alt:t("airstrip9"), src: Airstrip9},
    {alt:t("airstrip10"), src: Airstrip10},
    {alt:t("airstrip11"), src: Airstrip11},
    {alt:t("airstrip12"), src: Airstrip12},
    {alt:t("airstrip13"), src: Airstrip13},
    {alt:t("airstrip14"), src: Airstrip14},
  ];

  const logmentPictures = [
    {alt:t("home"), src: Logment1},
